...
void River(float y, float scale)//obj3
{
    ...
    glBegin(GL_LINES);
        glVertex2f(-190, -80); glVertex2f(-180, -80);
        glVertex2f(-170, -70); glVertex2f(-130, -70);
        glVertex2f(-160, -90); glVertex2f(-140, -90);
        glVertex2f(-130, -80); glVertex2f(-110, -80);
    glEnd();
    glPopMatrix();
    ...
    glBegin(GL_LINES);
        glVertex2f(-100, -90); glVertex2f(-80, -90);
        glVertex2f(-80, -80); glVertex2f(-40, -80);
        glVertex2f(-60, -70); glVertex2f(-30, -70);
        glVertex2f(-50, -90); glVertex2f(-20, -90);
    glEnd();
    glPopMatrix();
    ...
    glBegin(GL_LINES);
        glVertex2f(-20, -80); glVertex2f(-10, -80);
        glVertex2f(10, -90); glVertex2f(30, -90);
        glVertex2f(20, -80); glVertex2f(40, -80);
        glVertex2f(10, -70); glVertex2f(90, -70);
    glEnd();
    glPopMatrix();
    ...
    glBegin(GL_LINES);
        glVertex2f(60, -90); glVertex2f(110, -90);
        glVertex2f(110, -80); glVertex2f(130, -80);
        glVertex2f(125, -75); glVertex2f(170, -75);
        glVertex2f(150, -80); glVertex2f(160, -80);
        glVertex2f(140, -90); glVertex2f(170, -90);
        glVertex2f(180, -80); glVertex2f(190, -80);
    glEnd();
    glPopMatrix();
    ...
    glBegin(GL_LINES);
        glVertex2f(-170, -65); glVertex2f(-130, -65);
        glVertex2f(-150, -70); glVertex2f(-120, -70);
    glEnd();
    glPopMatrix();
    ...
    glBegin(GL_LINES);
        glVertex2f(0, -85); glVertex2f(40, -85);
        glVertex2f(10, -75); glVertex2f(50, -75);
    glEnd();
    glPopMatrix();
    ...
    glBegin(GL_LINES);
        glVertex2f(100, -70); glVertex2f(140, -70);
        glVertex2f(120, -80); glVertex2f(160, -80);
    glEnd();
    glPopMatrix();
...
// ============================================================
int currentScenario = 1;  // 1 = City Scene (Scenario 1), 2 = River City (Scenario 2)
    ...
    if (currentScenario == 2)
    {
        ...
        case 'a':
            if (dirCar1 == 1)
                ...
                speedCar1 -= accel;
                if (speedCar1 <= 0) { speedCar1 = 0; dirCar1 = 1; }
            }
            break;
        case 'q':
            if (dirCar1 == -1)
        ...
        case 'w':
            if (dirCar2 == 1)
                ...
                speedCar2 -= accel;
                if (speedCar2 <= 0) { speedCar2 = 0; dirCar2 = 1; }
            }
            break;
        case 's':
            if (dirCar2 == -1)
            ...
            break;
        case 'x':
            speedCar2 = 0; wheelSpeed2 = 0;
            break;
        case 'e':
            callStars = -1 * callStars;
            break;
        case 'd':
            callMoon = -1 * callMoon;
            break;
        ...
        case 'b':
            ...
            if (nightSky == -1) {
                nlRoad = -1;
                nlBuilding2 = -1; nlBuilding3 = -1; nlBuilding6 = -1;
                nlBackBuilding3 = -1;
                hlCar1 = -1; hlCar2 = -1;
                nlBoat = -1; ntWindow = -1;
            } else {
...
void handleMouse(int button, int state, int x, int y)
{
    if (currentScenario == 1 || currentScenario == 12)
    {
        // Scenario 1: Left click = faster clouds, Right click = slower clouds
    ...
    {
        // Scenario 2: cloud movement control
        if (state == GLUT_DOWN) {
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("A BEAUTIFUL CITY  |  Press 0 = City Scene  |  9 = River City Scene");
